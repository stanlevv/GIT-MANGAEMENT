...
import { CreditCard, Heart, BarChart2 } from "lucide-react";
...
const SLIDES = [
  {
    ...
    badge: <span className="flex items-center gap-1.5"><CreditCard size={14} /> Pembayaran Digital</span>,
    title: "Bayar SPP\nLebih Mudah",
  ...
  },
  {
    ...
    badge: <span className="flex items-center gap-1.5"><Heart size={14} /> Kampanye Donasi</span>,
    title: "Bantu Sesama\nPelajar Indonesia",
  ...
  },
  {
    ...
    badge: <span className="flex items-center gap-1.5"><BarChart2 size={14} /> Laporan Transparan</span>,
