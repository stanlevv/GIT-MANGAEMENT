...
const DEMOS = [
  ...
  { label: "🎓 Siswa/Ortu", email: "hendra@gmail.com", password: "password123", color: "#1677FF", bg: "#EEF4FF" },
  { label: "❤️ Donatur", email: "rina@gmail.com", password: "password123", color: "#B07D00", bg: "#FFF7E0" },
];
