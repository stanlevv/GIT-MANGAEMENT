...
import { Search, Heart, Star, TrendingUp, RefreshCw } from "lucide-react";
        ...
        <div className="px-6 py-3" style={{ background: "#FFF7E6" }}>
          <div className="flex items-center gap-2">
            ...
            <span style={{ color: "#FD9A16", fontWeight: 600, fontSize: "0.82rem" }}>
              Beberapa kampanye hampir mencapai target! Yuk ikut berdonasi 🎯
            </span>
          </div>
        </div>
      )}
              ...
              <div className="relative h-44 overflow-hidden">
                ...
                {pct >= 80 && (
                  <div className="absolute top-3 left-3 flex items-center gap-1 px-2 py-0.5 rounded-full"
                    ...
                    <span style={{ fontSize: "0.65rem", color: "white", fontWeight: 700 }}>🔥 Hampir Target</span>
                  </div>
                )}
              </div>
