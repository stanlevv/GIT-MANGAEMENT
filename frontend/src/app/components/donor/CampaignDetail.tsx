...
import { ArrowLeft, Heart, Share2, CheckCircle, Users, RefreshCw, LogIn } from "lucide-react";
    ...
    return (
      <div className="flex flex-col min-h-screen bg-white">
        ...
        <div className="px-6 pt-4 pb-20" style={{ boxShadow: "0 -4px 20px rgba(0,0,0,0.06)" }}>
          {submitError && (
            <p style={{ color: "#CF1322", fontSize: "0.8rem", marginBottom: "8px", textAlign: "center" }}>
              ⚠️ {submitError}
            </p>
          )}
          <button
    ...
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <div className="flex-1 overflow-y-auto pb-44">
        <div className="px-6 py-5">
          ...
          <p style={{ color: "#8C8C8C", fontSize: "0.82rem", marginBottom: "16px" }}>🏫 Kampanye Pendidikan</p>
