      ...
      <div className="w-full max-w-[430px] bg-white rounded-t-3xl p-6 pb-8 animate-slide-up max-h-[85vh] overflow-y-auto">
        ...
        {SEMESTERS.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-10">
            <Award size={48} color="#BFBFBF" className="mb-4" />
            <p style={{ color: "#8C8C8C", fontSize: "0.9rem", textAlign: "center" }}>Data akademik belum tersedia dari sekolah.</p>
          </div>
        ) : (
          <>
            {/* Current Stats */}
                ...
                {selectedSemester.achievements.length > 0 ? (
                  <div>
                    ...
                    <div className="space-y-2">
                      {selectedSemester.achievements.map((ach: string, idx: number) => (
