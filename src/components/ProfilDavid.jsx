// Dipanggil oleh App.jsx melalui rute
...
const color    = "#34d399"
const colorBg  = "#0d2620"
const name     = "David Bimantoro Sarashadi"
const role     = "Frontend Engineer"
const photoSrc = "/GIT-MANGAEMENT/img/fotodavid.png"
const kelas    = "TI-2D"
const domisili = "Depok"
const jurusan  = "Teknologi Informasi"
const skills   = ["React", "TypeScript", "Node.js", "Tailwind", "Next.js"]
const description = `Halo, perkenalkan saya David Bimantoro Sarashadi. Saat ini saya menempuh pendidikan pada program studi Teknologi Informasi dengan fokus pada pengembangan frontend web. Saya memiliki ketertarikan yang sangat tinggi dalam menulis kode yang bersih, terstruktur, serta memiliki tata arsitektur performa yang kencang menggunakan ekosistem pengembangan modern seperti React dan Tailwind. Bagi saya pribadi, pengembangan sebuah aplikasi modern adalah sebuah seni yang menggabungkan logika murni dengan kreativitas visual yang estetis. Selain beraktivitas di bangku perkuliahan secara akademik, saya juga mengambil proyek freelance perangkat lunak kecil-kecilan guna mempertajam kapasitas kemampuan teknis saya, sekaligus melatih diri dalam menerjemahkan kebutuhan dan objektif pengguna ke dalam sebuah solusi digital yang utuh. Target jangka panjang saya adalah membimbing komunitas engineer handal di masa depan dan memberikan dampak positif bagi industri teknologi Indonesia.`
        ...
        <div style={{ marginBottom: "32px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "24px", alignItems: "center" }}>
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
              {[
                { name: "Frontend Arch", val: 92 },
                { name: "Performance", val: 88 },
                { name: "Clean Code", val: 95 }
              ].map(s => (
                <div key={s.name}>
          ...
          <div style={{ display: "flex", justifyContent: "center" }}>
            <svg width="120" height="120" viewBox="0 0 120 120" style={{ filter: `drop-shadow(0 0 12px ${color}33)` }}>
              ...
              <polygon points="60,20 100,50 90,105 30,90 20,60" fill={`${color}22`} stroke={color} strokeWidth="2" />
              <circle cx="60" cy="20" r="3" fill={color} />
              <circle cx="100" cy="50" r="3" fill={color} />
              <circle cx="90" cy="105" r="3" fill={color} />
      ...
      <div style={{ flex:"0 0 240px", display:"flex", flexDirection:"column", alignItems:"center", gap:"16px" }}>
        <div style={{ width:"240px", height:"300px", borderRadius:"24px", overflow:"hidden", border:`2px solid ${color}33`, boxShadow:`0 24px 64px ${color}22`, position:"relative" }}>
          <img src={photoSrc} alt={name} style={{ width:"100%", height:"100%", objectFit:"cover", objectPosition:"top center" }}
            onError={e=>{e.currentTarget.style.display="none"; e.currentTarget.parentElement.style.background=colorBg; e.currentTarget.parentElement.style.display="flex"; e.currentTarget.parentElement.style.alignItems="center"; e.currentTarget.parentElement.style.justifyContent="center"; e.currentTarget.parentElement.innerHTML=`<span style="font-size:48px;font-weight:800;color:${color};font-family:DM Mono,monospace">DB</span>`}}
          />
        ...
        <div style={{ width: "100%", background: "#111118", border: "1px solid #ffffff0a", borderRadius: "18px", padding: "20px", marginTop: "12px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
            {[
              { label: "Frontend Arch", val: "Senior" },
              { label: "State Mgmt", val: "Redux/Zustand" },
              { label: "API Integration", val: "Rest/GraphQL" }
            ].map(item => (
        ...
        <div style={{ width: "100%", background: "#111118", border: "1px solid #ffffff0a", borderRadius: "18px", padding: "20px", marginTop: "12px" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "12px" }}>
            <span style={{ fontSize: "10px", color: "#4a4960", fontFamily: "'DM Mono', monospace", textTransform: "uppercase", letterSpacing: "1px" }}>Code Commits</span>
            <span style={{ fontSize: "10px", color, fontFamily: "'DM Mono', monospace", fontWeight: "700" }}>Stable</span>
          </div>
          <div style={{ height: "40px", width: "100%", overflow: "hidden" }}>
            <svg width="100%" height="100%" preserveAspectRatio="none" viewBox="0 0 100 40">
              <defs>
                <linearGradient id="lineGradSurya" x1="0%" y1="0%" x2="0%" y2="100%">
                  <stop offset="0%" stopColor={color} stopOpacity="0.3" />
                  <stop offset="100%" stopColor={color} stopOpacity="0" />
                </linearGradient>
              </defs>
              <path d="M0,20 L15,18 L30,22 L45,15 L60,19 L75,12 L100,25 V40 H0 Z" fill="url(#lineGradSurya)" />
              <path d="M0,20 L15,18 L30,22 L45,15 L60,19 L75,12 L100,25" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ filter: `drop-shadow(0 0 6px ${color}88)` }} />
            </svg>
          </div>
        </div>
      </div>
