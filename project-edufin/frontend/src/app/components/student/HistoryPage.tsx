...
export function HistoryPage() {
  ...
  const totalOut = HISTORY.reduce((s, h) => s + h.amount, 0);
  ...
  return (
    <div className="flex flex-col min-h-screen" style={{ background: "#F5F7FA" }}>
      ...
      <div className="px-6 pt-12 pb-5" style={{ background: "linear-gradient(160deg, #1677FF 0%, #108EE9 100%)" }}>
        ...
        <p style={{ color: "rgba(255,255,255,0.7)", fontSize: "0.78rem", marginTop: "4px" }}>SPP, cicilan, dan donasi Anda</p>
        ...
        <div className="rounded-2xl p-4 mt-4" style={{ background: "rgba(255,255,255,0.15)" }}>
          <div className="flex items-center gap-1.5 mb-1">
            ...
            <span style={{ color: "rgba(255,255,255,0.7)", fontSize: "0.75rem" }}>Total Pengeluaran</span>
          </div>
        ...
        {filtered.map((h) => (
          <div key={h.id} className="bg-white rounded-2xl p-4 shadow-sm flex items-center gap-3">
            <div
              ...
              style={{
                background: h.category === "SPP" ? "#EEF4FF" : h.category === "Cicilan" ? "#FFF7E6" : "#FFF2F0"
              }}
            >
              {h.category === "SPP"
            ...
            <div className="text-right">
              ...
              <span
                ...
                style={{
                  ...
                  color: h.status === "Berhasil" ? "#52C41A" : "#8C8C8C",
                  fontSize: "0.68rem",
                  fontWeight: 600
                }}
              >
